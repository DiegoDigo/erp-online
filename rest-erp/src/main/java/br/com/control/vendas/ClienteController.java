...
public class ClienteController {
	...
	public MensagemRetorno salvar(@RequestBody Cliente cliente) {
		Cliente clienteSalvo = servicoCliente.salvar(cliente);
		return new MensagemRetorno(HttpStatus.OK, "Cliente Salvo com Sucesso", clienteSalvo.getId().toString());
	}
