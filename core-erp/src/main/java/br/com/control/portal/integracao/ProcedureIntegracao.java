...
public enum ProcedureIntegracao {
	...
	INSERT_CAPA_PRE_PEDIDO(	"SP_INSERT_CAPAPREPEDIDO_SFA_CAMPO_NOVO",
							PedidoCapaTO.class),
	INSERT_ITEM_PRE_PEDIDO(	"SP_INSERT_ITEMPREPEDIDO_SFA_NOVO_CAMPOS",
							PedidoItemTO.class),
	LIBERACAO_PEDIDO(	"SP_LIB_PEDIDO",
						LiberacaoPedidoTO.class),
	INSERE_ALTERA_CLIENTE(	"SP_CRIA_ATUALIZA_CLIENTE_SFA",
							ClienteTO.class),
