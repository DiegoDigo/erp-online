...
public class AcompanhamentoPedidoDao extends JdbcDao<StatusAcompanhamentoPedido> {
	...
	public List<StatusAcompanhamentoPedido> listaAcompanhamentoPedido() {
		...
		return selectViewSemWhere(ViewsIntegracaoERP.VW_ACOMPANHAMENTO_PEDIDO, new StatusAcompanhamentoPedidoRowMapper());
	}
	...
	public StatusAcompanhamentoPedido recuperaAcompanhamentoPedido(String numeroPedido) {
		...
		getJdbcTemplate().update(declare);
		List<StatusAcompanhamentoPedido> retorno = selectViewSemWhere(ViewsIntegracaoERP.VW_ACOMPANHAMENTO_PEDIDO, new StatusAcompanhamentoPedidoRowMapper());
